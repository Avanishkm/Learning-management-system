  ...
  return (
    <div className='relative bg-gradient-to-r from-blue-500 bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center'>
        <div className='max-w-3xl mx-auto'>
            ...
            <form onSubmit={handleSearch} className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto mb-6'>
                <Input
                type="text"
                value={searchQuery}
                ...
                />
                <Button type="submit"  className='bg-blue-600 dark:bg-blue-700 text-white px-6 py-3 rounded-r-full hover:bg-blue-700' >Search</Button>
            </form>
